...
# -*- encoding: utf-8 -*-
# stub: parse_resource 1.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "fixtures/vcr_cassettes/test_find_should_throw_an_exception_if_object_is_nil.yml",
    ...
    "fixtures/vcr_cassettes/test_role_add_user.yml",
    "fixtures/vcr_cassettes/test_role_creation.yml",
    "fixtures/vcr_cassettes/test_role_remove_user.yml",
